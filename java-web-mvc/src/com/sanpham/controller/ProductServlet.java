...
import com.sanpham.service.ProductServiceIpml;
...
public class ProductServlet extends HttpServlet {
    ...
    private void createProduct(HttpServletRequest request, HttpServletResponse response) {
        ...
        String dateDeliver = request.getParameter("dateDeliver");
        String addressDeliver = request.getParameter("addressDeliver");
        int id = (int) (Math.random() * 1000);

        Product product = new Product(id, nameProduct, dateDeliver, addressDeliver);
    ...
    private void editProduct(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (product == null) {
            ...
            product.setDateDeliver(dateDeliver);
            product.setAddressDeliver(addressDeliver);
